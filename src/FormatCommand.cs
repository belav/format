...
namespace Microsoft.CodeAnalysis.Tools
{
    internal static class FormatCommand
    {
        ...
        internal static string[] SeverityLevels =>
            new[] { FixSeverity.Info, FixSeverity.Warn, FixSeverity.Error };
        ...
        internal static RootCommand CreateCommandLineOptions()
        {
            ...
            var rootCommand = new RootCommand
            {
                ...
                new Option(
                    new[] { "--fix-whitespace", "-w" },
                    Resources.Run_whitespace_formatting_Run_by_default_when_not_applying_fixes
                ),
                new Option(
                    new[] { "--fix-style", "-s" },
                ...
                new Option(
                    new[] { "--check" },
                    Resources.Formats_files_without_saving_changes_to_disk_Terminates_with_a_non_zero_exit_code_if_any_files_were_formatted
                ),
                new Option(
                    new[] { "--report" },
